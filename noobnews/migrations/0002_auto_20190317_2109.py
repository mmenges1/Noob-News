# -*- coding: utf-8 -*-
# Generated by Django 1.11.18 on 2019-03-17 21:09
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='videogamelist',
            name='userLibrary',
            field=models.ManyToManyField(blank=True, to='noobnews.VideoGame'),
        ),
        ...
        migrations.AddField(
            model_name='videogamelist',
            name='user',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='noobnews.UserProfile'),
        ),
    ]
