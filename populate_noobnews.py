...
import django
django.setup()
from noobnews.models import Genre, VideoGame
...
def populate():
     ...
     for cat, cat_data in action.items():
         ...
         for g in cat_data["VideoGame"]:
             add_videogame(g["name"], g["id"], v, g["description"], g["rating"], g["release"], g["developer"], g["publisher"], g["image"], g["youtubeurl"], g["speedRun"])
...
def add_videogame(name, id, genre, description, rating, release, developer, publisher, image, youtubeurl, speedRun):
    print(name);
    print(id);
    print(genre);
    print(description);
    ...
    print(publisher);
    print(image);
    v = VideoGame.objects.get_or_create(name=name, slug=slugify(name), id=id, genre=genre, description=description, rating=rating, release=release, developer=developer, publisher=publisher, image=image, youtubeurl=youtubeurl, speedRun=speedRun)[0]
    v.save()
    return v
